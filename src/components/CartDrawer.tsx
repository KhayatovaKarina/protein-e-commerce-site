  ...
  return (
    <>
      ...
      >
        ...
        {/* Free shipping notice - только после монтирования */}
        {mounted && totalAmount > 0 && totalAmount < 3000 && (
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          {mounted && items.length === 0 ? (
            ...
            // Заглушка на время гидратации - пустой блок, чтобы сохранить структуру
            <div className="flex-1" />
          )}
        </div>

        {/* Footer - только после монтирования и если есть товары */}
        {mounted && items.length > 0 && (
