...
const productData = [
  ...
  },
  {
    ...
    description:
      "Самый весёлый протеин на рынке! Розовая Жвачка — это ностальгия по детству в спортивном флаконе. Неповторимый вкус розовой жвачки с яркими пузырьками делает каждую тренировку праздником. Содержит полный аминокислотный профиль и инулин пребиотик для здоровья кишечника. Ограниченная серия — успей попробовать!",
    shortDescription: "Лимитированный вкус розовой жвачки, 25г",
    price: "2890.00",
    comparePrice: "3390.00",
    images: [
      "/images/product-bubblegum.jpg",
      "/images/lifestyle-2.jpg",
      "/images/lifestyle-1.jpg",
    ],
    flavor: "Жвачка",
